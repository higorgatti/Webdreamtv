    ...
    function NetflixMovies({ contentType = 'vod', categoryFilter = null }){
      ...
      const Movie = React.memo(({ movie, sectionId, idx }) => {
        ...
        return e('div', {
          ...
          // Overlay com informações (se tem trailer, fica embaixo; se não, cobre tudo)
          isHovered && e('div', {
              onClick: async (ev) => {
                ev.stopPropagation()
              ...
              style: {
                ...
                flexDirection: 'column',
                justifyContent: 'space-between',
                cursor: 'pointer', // ===== ADICIONADO: mostrar que é clicável =====
                pointerEvents: 'auto', // ===== CORRIGIDO: auto para permitir cliques nos botões =====
                zIndex: 2,
                willChange: 'opacity, top, height' // Otimização GPU
              }
            },
              // Título no topo
              e('div', {
                style: {
                  ...
                  WebkitLineClamp: '2',
                  WebkitBoxOrient: 'vertical',
                  pointerEvents: 'none' // Texto não deve capturar cliques
                }
              }, `${enrichedMovie.name || enrichedMovie.title}${enrichedMovie.tmdb_year ? ` (${enrichedMovie.tmdb_year})` : ''}`),

              // Informações + Botões na parte inferior
              e('div', {
                style: {
                  display: 'flex',
                  flexDirection: 'column',
                ...
                // Porcentagem de relevância + Metadados em linha
                e('div', {
                  style: {
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    color: '#ddd',
                    flexWrap: 'wrap',
                    pointerEvents: 'none' // Metadados não devem capturar cliques
                  }
                },
                ...
                // Sinopse melhorada - 5 linhas com expansão no hover
                enrichedMovie.tmdb_overview && e('div', {
                  style: {
                    ...
                    pointerEvents: 'none' // Sinopse não deve capturar cliques
                  }
                ...
                isHovered && (enrichedMovie.tmdb_cast || enrichedMovie.tmdb_director) && e('div', {
                  ...
                  enrichedMovie.tmdb_director && e('div', null,
                    e('span', { style: { color: '#f47521', fontWeight: 'bold' } }, '🎬 '),
                  ...
                  onClick: async () => {
                    if(enrichedMovie.tmdb_id) {
                      ...
                      if(trailerUrl) {
                        ...
                        setToast('❌ Trailer não disponível')
                        setTimeout(() => setToast(null), 3000)
                      }
                    }
                  },
            ...
            ) // End informações + botões container
          ), // End overlay div

          // Botão Mute/Unmute no canto do TRAILER (estilo Netflix)
